    ...
    <React.Fragment>
      <Grid container className={classes.root} direction="row" justify="center" spacing={2}>
        ...
        <Grid item xs={12} style={{textAlign: 'right'}}>
          <img src={perfildesgaste0} alt={'perfildesgaste0'} style={{height: '100%'}}/>
        </Grid>
        <Grid item xs={10}>
          <Paper elevation={3}  className={classes.imgCenter}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={3} mt={12}>
                <img src={perfildesgaste1} alt={'perfildesgaste1'} style={{width: '100%'}}/>
              </Grid>
              <Grid item xs={9} mt={12} >
                <img src={perfildesgastetable1} alt={'perfildesgastetable1'} style={{width: '100%'}}/>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
        <Grid item xs={10}>
          <Paper elevation={3}  className={classes.imgCenter}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={3} mt={12}>
                <img src={perfildesgaste2} alt={'perfildesgaste2'} style={{width: '100%'}}/>
              </Grid>
              <Grid item xs={9} mt={12} >
                <img src={perfildesgastetable2} alt={'perfildesgastetable2'} style={{width: '100%'}}/>
