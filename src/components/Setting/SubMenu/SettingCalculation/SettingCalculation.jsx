      ...
      <Grid container className={classes.root} direction="row" justify="center" spacing={2}>
          ...
          <Paper elevation={3}  className={classes.imgCenter}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6} mt={12}>
                <img src={settingcalculation1} alt={'settingcalculation1'} style={{width: '100%'}}/>
              </Grid>
        ...
        <Grid item xs={5} mt={12}>
          <Paper elevation={3}  className={classes.imgCenter}>
            ...
            <img src={settingcalculation2} alt={'settingcalculation2'} style={{width: '90%'}}/>
          </Paper>
        </Grid>
        <Grid item xs={5}>
          <Paper elevation={3}  className={classes.imgCenter}>
            <Typography  variant="h3" >Setting v/s Altura de poste</Typography>
            <img src={settingcalculation3} alt={'settingcalculation3'} style={{width: '90%'}} />
          </Paper>
        </Grid>
      </Grid>
    </React.Fragment>
