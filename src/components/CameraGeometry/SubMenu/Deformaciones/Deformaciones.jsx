    ...
    <React.Fragment>
      <Grid container className={classes.root} direction="row" justify="center" spacing={2}>
        ...
        <Grid item xs={12} style={{textAlign: 'right'}}>
          <img src={deformaciones1} alt={'deformaciones1'} style={{height: '100%'}}/>
        </Grid>
        <Grid item xs={10}>
          <Paper elevation={3}  className={classes.imgCenter}>
            ...
            <Grid container spacing={2} direction="row" justify="center">
              ...
              <Grid item xs={12} mt={12} >
                <img src={deformaciones2} alt={'deformaciones2'} style={{width: '90%'}}/>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
        <Grid item xs={10}>
          <Paper elevation={3}  className={classes.imgCenter}>
            ...
            <Grid container spacing={2} direction="row" justify="center">
              <Grid item xs={12} mt={12} >
                <img src={deformaciones3} alt={'deformaciones3'} style={{width: '90%'}}/>
              </Grid>
            </Grid>
          </Paper>
        </Grid>
